...
class GenerativeAdversarialNetworks(BaseModel):
    def __init__(self, cfg) -> None:
        ...
        self.save_image_dir = os.path.join(self.cfg.save_image_path, self.name, self.cfg.Data.dataset)
        self.save_model_dir = os.path.join(self.cfg.save_model_path, self.name, self.cfg.Data.dataset)
        ...
        # Optimizer
        self.d_optimizer = torch.optim.Adam(self.disriminator.parameters(), lr= cfg.Optimizer.lr, betas=(cfg.Optimizer.beta1, cfg.Optimizer.beta2))
        self.g_optimizer = torch.optim.Adam(self.generator.parameters(),    lr= cfg.Optimizer.lr, betas=(cfg.Optimizer.beta1, cfg.Optimizer.beta2))
